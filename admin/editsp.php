...
<div class="input-group">
    <input type="text" id="soluong" name="soluong" value="<?php echo $product['StockQuantity']; ?>" required><br><br>
    <label for="username">Số lượng</label><br>
    </div>
    <div class="input-group">
        <input style="width:150px" oninput="formatInput(this)" type="text" id="gia" name="gia" value="<?php echo number_format($product['Price'],3) ; ?>" required>VNĐ
